    ...
    return (
        <div className="space-y-6 relative">
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-500">
                <Link href="/yudisium/submissions" className="hover:text-[#5AA0FF]">Submissions</Link>
                <span>/</span>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                ...
                <div className="flex flex-col items-end gap-2">
                    ...
                    <span className="text-xs text-gray-400">Submitted: {submission.submittedDate}</span>
                </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Left Column: Eligibility Check */}
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        <h2 className="text-lg font-bold text-gray-900 mb-4 border-b pb-2">Eligibility Check</h2>

                        <div className="space-y-6">
                            {/* Regular Credits */}
                            <div>
                                <div className="flex justify-between mb-1">
                                    <span className="text-sm font-medium text-gray-700">Regular Credits (SKS)</span>
                                ...
                                {submission.regularCredits < 144 && <p className="text-xs text-amber-600 mt-1">Warning: Below 144 credits requirement.</p>}
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                    <span className="text-xs text-gray-500 uppercase tracking-wide">Min GPA (2.00)</span>
                                    <div className="mt-1 flex items-center">
                                        <span className={`text-lg font-bold ${submission.minGpaPassed ? 'text-green-600' : 'text-red-600'}`}>
                                            {submission.minGpaPassed ? 'PASSED' : 'FAILED'}
                                        </span>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                    <span className="text-xs text-gray-500 uppercase tracking-wide">Transfer Credits</span>
                    ...
                    {(submission.issues && submission.issues.length > 0) ? (
                        ...
                        <div className="bg-green-50 p-6 rounded-xl border border-green-200 shadow-sm flex items-center">
                            ...
                            <span className="text-green-800 font-medium">All requirements appear complete.</span>
                        </div>
                    )}
                </div>
                        ...
                        {!isFinal ? (
                            <div className="space-y-3">
                                <p className="text-sm text-gray-500 mb-4">
                                    Please verify all requirements before making a decision. This action is final for this submission cycle.
                                </p>
                                <button
                                ...
                                <div className="text-sm space-y-2 mt-3">
                                    ...
                                    {submission.predicate && (
                                        <div className="pt-2 border-t border-green-200 mt-2">
                                            <span className="block text-xs text-gray-500 uppercase">Predicate</span>
                                            <span className="font-bold text-green-900">{submission.predicate}</span>
                                        </div>
                                    )}
                                    {submission.rejectReason && (
                                        <div className="pt-2 border-t border-red-200 mt-2">
                                            <span className="block text-xs text-gray-500 uppercase">Reason</span>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Select Predicate <span className="text-red-500">*</span></label>
                                <select
            ...
            {showRejectModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 animate-in fade-in zoom-in duration-200">
                        <h3 className="text-xl font-bold text-gray-900 mb-4">Reject / Request Revision</h3>
                        <div className="space-y-4">
                            <p className="text-sm text-gray-500">Please verify why this submission is being rejected. This reason will be visible to the student.</p>
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="e.g. Missing required document..."
                                />
                            </div>
                        </div>
                        <div className="mt-6 flex justify-end space-x-3">
