...
export default function GraduationCalculatorWarningPage() {
    ...
    // Dummy Requirements (WARNING STATE)
    const requirements = {
        regularCredits: { current: 42, target: 144, met: false },
        requiredCourses: { current: 16, target: 40, met: false },
        gpa: { current: 2.85, min: 2.0, met: true },
        transferCredits: 6
    };
    ...
    const confirmSubmitAnyway = () => {
        ...
        setTimeout(() => {
            ...
            setModalType('success'); // Trigger toast or just rely on banner
        }, 500);
    };
        ...
        <div className="max-w-4xl mx-auto space-y-8 pb-12 font-sans text-gray-800">
            ...
            <header className="text-center space-y-3 pt-6">
                ...
                <p className="text-gray-500 max-w-2xl mx-auto text-base">
                    Check eligibility based on regular credits, required courses, and GPA.
                    <br />Transfer credits are shown separately.
                </p>
            </header>
            ...
            {submissionStatus === 'pending' && (
                <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-blue-900 text-lg">Submission Request Pending</h3>
                            <p className="text-blue-700/80 text-sm">Your yudisium request has been submitted for review.</p>
                        </div>
                    </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="px-8 py-6 border-b border-gray-100 bg-gray-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="px-4 py-2 bg-amber-100 text-amber-700 font-bold rounded-full text-sm border border-amber-200 flex items-center shadow-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-end">
                                <div>
                                    ...
                                    <p className="text-xs text-xs text-gray-400">Regular course credits only</p>
                                </div>
                                <div className="text-right">
                                    <span className={`text-xl font-bold ${requirements.regularCredits.met ? 'text-green-600' : 'text-amber-600'}`}>
                            ...
                            <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden">
                                <div
                                    className={`h-full rounded-full transition-all duration-1000 ${requirements.regularCredits.met ? 'bg-green-500' : 'bg-amber-400'}`}
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-end">
                                ...
                                <div className="text-right">
                                    <span className={`text-xl font-bold ${requirements.requiredCourses.met ? 'text-green-600' : 'text-amber-600'}`}>
                            ...
                            <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden">
                                <div
                                    className={`h-full rounded-full transition-all duration-1000 ${requirements.requiredCourses.met ? 'bg-green-500' : 'bg-amber-400'}`}
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {requirements.gpa.met ? (
                                    <div className="flex items-center px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">
                                        PASS
                                    </div>
                                ) : (
                                    <div className="flex items-center px-2 py-1 bg-red-100 text-red-700 rounded text-xs font-bold">
                                        FAIL
                                    </div>
                                )}
                            </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-3xl shadow-xl max-w-md w-full p-8 relative animate-in zoom-in-95 duration-200">
                        ...
                        <p className="text-gray-500 text-center text-sm leading-relaxed mb-6">
                            You are not yet eligible (regular credits and/or required courses are incomplete). Are you sure you want to submit yudisium now?
                        </p>
            ...
            {/* Confirm Modal (if eligible, unlikely here) */}
            {modalType === 'confirm' && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-3xl shadow-xl max-w-md w-full p-8 relative animate-in zoom-in-95 duration-200">
