...
export default function StudentDashboardWarning() {
    ...
    const summaryData = [
        { label: 'Regular Credits', value: '42', sub: 'Course SKS only' },
        { label: 'Completed', value: '16/40', sub: 'Required Courses' },
        { label: 'GPA (IPK)', value: '2.85', sub: 'Scale 4.0' },
    ...
    const maxCreditsRules = [
        ...
        { gpa: '> 3.0 - 3.5', credit: 21, label: 'Very Good' },
        { gpa: '> 2.5 - 3.0', credit: 18, active: true, label: 'Good' }, // 2.85 falls here
        { gpa: '> 2.0 - 2.5', credit: 15, label: 'Fair' },
        { gpa: '≤ 2.0', credit: 12, label: 'Poor' },
    ];

    const triggeredReasons = [
        "Odd semester passed credits: 9 SKS (below 11 SKS)",
        "Semester GPA (IPS): 2.10 (below 2.30)",
        "GPA dropped significantly from 3.00 to 2.10",
        "Cumulative credits are below the even-semester target milestone"
    ];
        ...
        <div className="space-y-8 max-w-7xl mx-auto pb-12 font-sans">
            ...
            <div className="bg-amber-50 rounded-2xl border border-amber-200 p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-amber-900">Academic Warning: Action needed</h3>
                        <p className="text-amber-800/80 text-sm mt-1 max-w-xl">
                            Some evaluation criteria were triggered. Please review your status and consult your academic advisor immediately.
                        </p>
                        <p className="text-xs text-amber-600 mt-2 font-medium">You may receive an in-app notification reminder.</p>
                    </div>
                </div>
                <button
                    ...
                    <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative">
                        ...
                        <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">Performance assessment</p>
                            </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                ...
                                <div className="p-4 bg-amber-50/50 rounded-xl border border-amber-100">
                                    <span className="block text-xs text-amber-700 font-semibold mb-1">Latest IPS</span>
                            ...
                            <div className="mb-6">
                                <h3 className="text-xs font-bold text-gray-800 mb-2 uppercase tracking-wide">Triggered Reasons</h3>
                ...
                <div className="lg:col-span-7 h-full">
                    <section className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full min-h-[600px] overflow-hidden">
                        <div className="p-6 border-b border-gray-100">
                            ...
                            {/* Warning Note */}
                            <div className="bg-blue-50 px-4 py-2 rounded-lg mb-4 text-xs font-semibold text-blue-700 flex items-center gap-2">
                                <BookOpen className="w-4 h-4" />
                                Please prioritize taking the required courses listed below.
                            </div>
                        ...
                        <div className="flex-1 bg-gray-50/30 p-2 overflow-y-auto custom-scrollbar">
                            {activeTab === 'required' ? (
                                ...
                                <div className="p-8 text-center text-gray-400 text-sm">
                                    Dummy data for taken courses not shown for brevity in this view.
                                </div>
                            )}
                        </div>
                    </section>
